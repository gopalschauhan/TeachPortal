namespace TeachPortal.Identity.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<RegistrationResponse> Register(RegistrationRequest request)
        {
            ...
            if (result.Succeeded)
            {
                await _userManager.AddToRoleAsync(user, ApplicationConstants.TeacherRole);
                return new RegistrationResponse() { UserName = user.UserName, Token = new JwtSecurityTokenHandler().WriteToken(await GenerateToken(user)) };
            }
            else
            {
